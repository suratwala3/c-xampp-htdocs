...
@section("title") Delivery Guy's Stores - Dashboard
@endsection
@section('content')
<style>
        ...
        <div class="card">
            <div class="card-body">
                <legend class="font-weight-semibold text-uppercase font-size-sm">
                    <i class="icon-address-book mr-2"></i> Delivery Guy's Stores
                </legend>
                <div class="form-group row form-group-feedback form-group-feedback-right">
                    @if(count($userRestaurants) === 0)
                    <div class="col-lg-9">
                        <p class="text-warning">{{ $user->name }} is not assigned to take deliveries from any stores yet.</p>
                    </div>
                    @else
                    <br>
                    <div class="col-lg-9">
